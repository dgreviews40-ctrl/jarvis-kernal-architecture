...
export type MainView = 'DASHBOARD' | 'SETTINGS' | 'DEV' | 'INTEGRATIONS' | 'PERFORMANCE' | 'MARKETPLACE' | 'VECTOR_DB' | 'REALTIME' | 'VISION_MEMORY' | 'MODEL_MANAGER' | 'GPU_DASHBOARD' | 'LORA_DASHBOARD';
